...
public class HandleAktSverkaOneWeekPeriod(IBusinessPartnerService businessPartnerService, IMapper mapper)
{
    ...
    {
        var startDate = DateOnly.FromDateTime(DateTime.Today.AddDays(-7)).ToString("dd.MM.yyyy");
