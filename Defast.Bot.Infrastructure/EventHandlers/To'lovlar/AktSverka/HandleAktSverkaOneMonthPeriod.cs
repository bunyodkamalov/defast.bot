...
public class HandleAktSverkaOneMonthPeriod(IBusinessPartnerService businessPartnerService, IMapper mapper)
{
    ...
    {
        var startDate = DateOnly.FromDateTime(DateTime.Today.AddMonths(-1)).ToString("dd.MM.yyyy");
