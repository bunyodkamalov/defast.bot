...
public class HandleListOPayments(ICacheBroker cacheBroker,
    IIncomingPaymentsService incomingPaymentsService,
    IBusinessPartnerService businessPartnerService)
{
    public async ValueTask<Message> Handle(int pageToken, ITelegramBotClient telegramBotClient, CallbackQuery callbackQuery,
        ELanguage eLanguage,
