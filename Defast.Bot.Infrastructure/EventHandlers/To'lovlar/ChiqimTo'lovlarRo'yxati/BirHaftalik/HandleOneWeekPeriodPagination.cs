...
public class HandleOneWeekPeriodPagination(IIncomingPaymentsService incomingPaymentsService, IBusinessPartnerService businessPartnerService, ICacheBroker cacheBroker)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!await cacheBroker.TryGetAsync<List<IncomingPayment>?>("oneWeekPeriodOutgoingPayments", out var outgoingPayments, cancellationToken))
        {
