...
public class HandleOneDayPeriodPagination(IIncomingPaymentsService incomingPaymentsService, IBusinessPartnerService businessPartnerService, ICacheBroker cacheBroker)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!await cacheBroker.TryGetAsync<List<IncomingPayment>?>("oneDayPeriodOutgoingPayments", out var outgoingPayments, cancellationToken))
        {
