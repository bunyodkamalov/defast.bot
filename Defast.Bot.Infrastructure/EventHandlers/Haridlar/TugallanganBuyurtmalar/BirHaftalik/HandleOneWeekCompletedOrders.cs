...
public class HandleOneWeekCompletedOrders(IBusinessPartnerService businessPartnerService, IInvoicesService invoicesService, ICacheBroker cacheBroker)
{
        ...
        if (!orders!.Any())
            return await telegramBotClient.SendTextMessageAsync(
                ...
                eLanguage == ELanguage.Uzbek
                    ? "Bir haftalik tugallangan buyurtmalar topilmadi ❌"
